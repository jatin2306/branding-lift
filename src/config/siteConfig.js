...
export const siteConfig = {
  ...
  features: [
    { icon: 'web', label: 'Web & App Development', color: 'violet' },
    { icon: 'seo', label: 'SEO & Digital Marketing', color: 'purple' },
    { icon: 'smm', label: 'Social Media Marketing', color: 'orange' },
    { icon: 'ai', label: 'AI Automation & Integration', color: 'blue' },
    { icon: 'brand', label: 'Branding & Design', color: 'pink' },
    { icon: 'orm', label: 'Business Growth', color: 'teal' },
  ],
  deviceFrame: '/device-frame.png',
  dashboard: {
    laptop: {
      kicker: 'Performance Overview',
      titlePlain: 'Driving ',
      titleHighlight1: 'Growth',
      titleMid: ', Delivering ',
      titleHighlight2: 'Results',
      note1: 'Smart strategies. Powerful solutions.',
      note2: 'Real business impact.',
      chartPoints: [20, 35, 30, 50, 45, 65, 60, 80, 75, 95],
      growthBadge: { value: '+320%', label: 'vs Last 6 Months', title: 'Total Growth' },
      stats: [
        { label: 'Visitors', value: '78.4K', delta: '+12.5%' },
        { label: 'Leads', value: '2.45K', delta: '+18.7%' },
        { label: 'Sales', value: '$120K', delta: '+25.3%' },
      ],
      donut: { value: '98%', label: 'Growth Rate' },
    },
    phone: {
      title: 'Your Success Is Our Mission',
      subtitle: 'We turn ideas into digital success stories.',
      avatarsCount: 4,
      clientsLabel: '500+ Happy Clients',
    },
  },
},
  whatsapp: {
